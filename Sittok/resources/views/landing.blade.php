...
<html lang="en">
  ...
  <head>
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="#" class="logo">
                            <img src="landing/images/sittok-gambar.png" width="70px" style="margin-top: -20px" alt="Sittok"/>
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li><a href="loginn" class="active">Login Admin</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                            <div class="features-small-item">
                                <div class="icon">
                                    <i><img src="landing/images/featured-item-01.png" alt=""></i>
                                </div>
                                <h5 class="features-title">Produk Berkualitas</h5>
                                <p>Produk yang kami sediakan dan kami jual merupakan produk yang berkualitas tinggi dengan garansi yang menjamin kualitas produk</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.4s">
                            <div class="features-small-item">
                                ...
                                <h5 class="features-title">Pelayanan Professional</h5>
                                <p>Toko kami akan melayani customer sepenuh hati dengan memberikan kebutuhan & keinginan customer</p>
                            </div>
                        </div>
                        <!-- ***** Features Small Item End ***** -->
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.6s">
                            <div class="features-small-item">
                                ...
                                <h5 class="features-title">Bonus Pembelian</h5>
                                <p>Kami akan memberikan bonus aksesoris setiap pembelian Laptop</p>
                            </div>
                        </div>
                        <!-- ***** Features Small Item End ***** -->
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="team-item">
                        <div class="team-content">
                            <i><img src="landing/images/testimonial-icon.png" alt=""></i>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="blog-post-thumb">
                        <div class="img">
                            <img src="landing/images/blog-item-01.png" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="blog-post-thumb">
                        <div class="img">
                            <img src="landing/images/blog-item-02.png" alt="">
                        </div>
                        <div class="blog-content">
                            <h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="blog-post-thumb">
                        <div class="img">
                            <img src="landing/images/blog-item-03.png" alt="">
                        </div>
                        <div class="blog-content">
                            <h3>
    ...
    <!-- jQuery -->
    <script src="landing/js/jquery-2.1.0.min.js"></script>
    ...
    <script src="landing/js/imgfix.min.js"></script> 
